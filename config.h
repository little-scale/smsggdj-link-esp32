...
#define PIN_TR   3   // XIAO D1 / GPIO3  -> port-2 pin 9 (TR)  = counter bit 0
#define PIN_TH   4   // XIAO D2 / GPIO4  -> port-2 pin 7 (TH)  = counter bit 1
...
// --- Presenter timer ---
#define PRESENTER_HZ    1000   // how often the ISR advances the counter / writes pins
